    ...
    <footer>
      <div>
        ...
        <a href="<?php echo get_site_url(); ?>/site/">About this Site</a>
        <a href="<?php echo get_site_url(); ?>/screenshots/">About Screenshots</a>
        <a href="<?php echo get_site_url(); ?>/about#senpai/">先輩</a>
